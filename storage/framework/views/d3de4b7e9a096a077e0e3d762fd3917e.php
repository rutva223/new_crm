...
<link rel="stylesheet" href="<?php echo e(asset('assets/vendor/bootstrap-select-country/css/bootstrap-select-country.min.css')); ?>">
<link href="<?php echo e(asset('assets/vendor/datepicker/css/bootstrap-datepicker.min.css')); ?>" rel="stylesheet">
<!--swiper-slider-->
<link rel="stylesheet" href="<?php echo e(asset('assets/vendor/swiper/css/swiper-bundle.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('assets/vendor/metismenu/css/metisMenu.min.css')); ?>">
<!-- Style css -->
 <!-- Datatable -->
 ...
 <link href="<?php echo e(asset('assets/vendor/datatables/responsive/responsive.css')); ?>" rel="stylesheet">
...
<link href="<?php echo e(asset('assets/css/dragula.min.css')); ?>" rel="stylesheet" />
