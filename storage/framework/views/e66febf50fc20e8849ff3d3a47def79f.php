        ...
        <div class="collapse navbar-collapse justify-content-between">
            ...
            <ul class="navbar-nav header-right">
                ...
                <li class="nav-item dropdown notification_dropdown" id="theme_changes" style="cursor: pointer">
                    <a class="nav-link ">
                        <i id="icon-light" class="fas fa-sun <?php echo e($theme == 'light' ? 'd-none' : ''); ?> "></i>
                        <i id="icon-dark" class="fas fa-moon <?php echo e($theme == 'dark' ? 'd-none' : ''); ?> "></i>
                    </a>
                </li>
                <li class="nav-item dropdown notification_dropdown">
                    <a class="nav-link bell-link" href="<?php echo e(route('plan.index')); ?>">
                                    ...
                                    <div class="timeline-panel">
                                        <div class="media me-2">
                                            <img alt="image" width="50"
                                                src="<?php echo e(asset('assets/images/avatar/1.png')); ?>">
                                        </div>
                    ...
                    <div class="dropdown header-profile2">
                            ...
                            <div class="header-info2 d-flex align-items-center">
                                <div class="d-flex align-items-center sidebar-info">
                                    <div class="d-none d-md-block">
                                        <h5 class="mb-0"><?php echo e(__('Welcome')); ?></h5>
                                        <p class="mb-0 text-end"><?php echo e(\Auth::user()->name ?? ''); ?></p>
                                    </div>
                                </div>
                                <?php if(\Auth::user()->avatar != null): ?>
                                    <img src="<?php echo e(asset('/avatars/' . \Auth::user()->avatar)); ?>">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('/assets/images/avatar/1.png')); ?>">
                                <?php endif; ?>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="#" class="dropdown-item ai-icon ">
                                ...
                                <span class="ms-2"><?php echo e(__('Profile')); ?></span>
                            </a>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage setting')): ?>
                                <a href="<?php echo e(route('setting.index')); ?>" class="dropdown-item ai-icon ">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                        class="svg-main-icon">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <span class="ms-2"><?php echo e(__('Settings')); ?></span>
                                </a>
                            <?php endif; ?>
                            <form method="POST" action="<?php echo e(route('logout')); ?>" id="form_logout">
                                <a href="route('logout')"
                                    ...
                                    <?php echo csrf_field(); ?>
                                    <span class="ms-2 text-danger"><?php echo e(__('LogOut')); ?> </span>
                                </a>
                            </form>
                        </div>
                    </div>
