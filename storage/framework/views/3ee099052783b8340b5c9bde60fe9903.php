...
<head>
    ...
    <?php echo $__env->make('partials.admin.head',['theme'=>$theme], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</head>
<body data-theme-version="<?php echo e($theme); ?>">
    ...
    ***********************************-->
    <div id="main-wrapper" class="">
        ...
        ***********************************-->
        <div class="header">
            <?php echo $__env->make('partials.admin.header',['theme'=>$theme], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <!--**********************************
                                ...
                                <ol class="breadcrumb">
                                    <?php if(!empty($breadcrumb)): ?>
                                        ...
                                        <?php $__currentLoopData = $breadcrumb; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="breadcrumb-item  <?php echo e($loop->last ? 'active' : ''); ?>" aria-current="page">
                                                <?php echo e($item); ?></li>
...
<?php /**PATH C:\laragon\www\new_crm\resources\views/layouts/admin.blade.php ENDPATH**/ ?>