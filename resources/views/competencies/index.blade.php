...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0 ">{{__('Manage Competencies')}}
@endsection
@section('breadcrumb')
...
@section('action-btn')
    ...
    <a href="#" class="btn btn-sm btn-primary btn-icon m-1" data-ajax-popup="true"
      data-url="{{ route('competencies.create') }}"
    data-title="{{__('Create New Competencies')}}"> <span class="text-white">
