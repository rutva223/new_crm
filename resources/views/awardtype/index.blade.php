...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0 ">{{__('Award Type')}}
@endsection
@section('breadcrumb')
...
@section('action-btn')
    ...
    <a href="#" class="btn btn-sm btn-primary btn-icon m-1" data-ajax-popup="true"
      data-url="{{ route('award-type.create') }}"
    data-title="{{__('Create New Award Type')}}"> <span class="text-white">
                                ...
                                @if(\Auth::user()->type=='company')
                                    <td class="text-right">
                                        ...
                                        <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-ajax-popup="true"
                                              data-url="{{ route('award-type.edit',$awardtype->id) }}"
                                            data-title="{{__('Edit Award Type')}}" > <span class="text-white"> <i
