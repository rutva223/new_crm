...
@section('action-btn')
    ...
    <a href="#" class="btn btn-sm btn-primary btn-icon m-1" data-ajax-popup="true"
      data-url="{{ route('promotion.create') }}" data-size="lg"
    data-title="{{__('Create New Promotion')}}"> <span class="text-white">
                                        ...
                                        <td class="text-right">
                                            <div class="action-btn bg-info ms-2">
                                                <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-ajax-popup="true"
                                                      data-url="{{ route('promotion.edit',$promotion->id) }}" data-size="lg"
                                                    data-title="{{__('Edit Promotion')}}"> <span class="text-white"> <i
