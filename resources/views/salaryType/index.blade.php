...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0 ">{{__('Salary Type')}}
@endsection
@section('breadcrumb')
...
@section('action-btn')
    ...
    <a href="#" class="btn btn-sm btn-primary btn-icon m-1" data-ajax-popup="true"
      data-url="{{ route('salaryType.create') }}"
    data-title="{{__('Create New Salary Type')}}"> <span class="text-white">
                                    ...
                                    <td class="table-actions text-end">
                                        <div class="action-btn bg-info ms-2">
                                            <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-ajax-popup="true"
                                                  data-url="{{ route('salaryType.edit',$type->id) }}"
                                                data-title="{{__('Edit Salary Type')}}" > <span class="text-white"> <i
