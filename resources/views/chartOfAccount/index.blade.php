...
@section('action-btn')
    @if(\Auth::user()->type=='company')
        <a href="#" class="btn btn-sm btn-primary btn-icon m-1" data-ajax-popup="true"
          data-url="{{ route('chart-of-account.create') }}"
        data-title="{{__('Create New Account')}}"> <span class="text-white">
                                        ...
                                        <tr>
                                            ...
                                            <td class="Action">
                                                    ...
                                                    <div class="action-btn bg-warning ms-2">
                                                        ...
                                                        data-title="{{__('View Account')}}"> <span class="text-white"> <i
                                                    ...
                                                    <div class="action-btn bg-info ms-2">
                                                        ...
                                                        data-title="{{__('Edit Account')}}"> <span class="text-white"> <i
