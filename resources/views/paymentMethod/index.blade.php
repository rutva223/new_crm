...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0 ">{{__('Payment Method')}}
@endsection
@section('breadcrumb')
...
@section('action-btn')
    ...
    data-title="{{__('Create New Payment Method')}}"> <span class="text-white">
                                        ...
                                        <td class="text-end">
                                            <div class="action-btn bg-info ms-2">
                                                <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-ajax-popup="true"
                                                      data-url="{{ route('paymentMethod.edit',$paymentMethod->id) }}"
                                                    data-title="{{__('Edit paymentMethod')}}" > <span class="text-white"> <i
