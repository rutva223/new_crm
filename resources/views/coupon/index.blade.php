...
@endsection
@section('action-btn')
    <a href="#" data-url="{{ route('coupon.create') }}" data-size="lg" data-ajax-popup="true"
      data-title="{{__('Create Coupon')}}" data-title="{{__('Create New Coupon')}}" class="btn btn-sm btn-primary btn-icon m-1" data-toggle="tooltip">
        <span class="btn-inner--icon"><i class="fa fa-plus" data-bs-toggle="tooltip" data-bs-original-title="{{ __('Create') }}"></i></span>
    </a>
@endsection
@section('content')
<div class="col-xl-12">
                                    ...
                                    <div class="actions ml-3">
                                        ...
                                        <div class="action-btn bg-info ms-2">
                                            <a href="#!"  data-size="lg" data-url="{{ route('coupon.edit',$coupon->id) }}"
                                                data-ajax-popup="true"    data-title="{{__('Edit Coupon')}}" class="mx-3 btn btn-sm d-inline-flex align-items-center">
