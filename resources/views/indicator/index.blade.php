...
@section('action-btn')
    ...
    <a href="#" class="btn btn-sm btn-primary btn-icon m-1" data-size="lg" data-ajax-popup="true"
      data-url="{{ route('indicator.create') }}"
                                        ...
                                        <td class="text-right">
                                            <div class="action-btn bg-warning ms-2">
                                                <a href="#" class="mx-3 btn btn-sm d-flex align-items-center" data-size="lg"
                                                    ...
                                                    data-title="{{ __('View Indicator') }}"> <span
                                                        class="text-white"> <i class="fa fa-eye" data-bs-toggle="tooltip"
                                                            data-bs-original-title="{{ __('View') }}"></i></span></a>
                                            </div>

                                            <div class="action-btn bg-info ms-2">
                                                <a href="#" data-size="lg" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-ajax-popup="true"
                                                  data-url="{{ route('indicator.edit',$indicator->id) }}"
                                                data-title="{{__('Edit Indicator')}}"> <span class="text-white">
                                                <i class="fa fa-edit" data-bs-toggle="tooltip" data-bs-original-title="{{ __('Edit') }}"></i></span></a>
                                            </div>
