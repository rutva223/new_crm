...
@section('content')
    <div class="col-sm-12">
        <div class="mt-2 " id="multiCollapseExample1">
            <div class="card">
                <div class="card-body">
                    {{ Form::open(['route' => ['user.userlog'], 'method' => 'get', 'id' => 'user_userlog']) }}
                    <div class="row align-items-center justify-content-end">
                        <div class="col-xl-9">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                    <div class="btn-box">
                                        {{ Form::label('users', __('Employee'), ['class' => 'form-label']) }}
                        ...
                        <div class="col-auto my-1 p-0 mt-2 px-2">
                                        <a href="{{ route('user.userlog') }}" data-bs-toggle="tooltip"
