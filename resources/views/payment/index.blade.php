...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0 ">{{__('Payment')}}
@endsection
@section('breadcrumb')
...
@section('action-btn')
    @if(\Auth::user()->type=='company')
        <a href="#" data-size="lg" data-url="{{ route('payment.create') }}" data-ajax-popup="true"
                                        ...
                                        <td class="text-right">
                                            <div class="action-btn bg-info ms-2">
                                                <a href="#"  data-size="lg" data-url="{{ route('payment.edit',$payment->id) }}"
                                                    data-ajax-popup="true"   class="mx-3 btn btn-sm d-inline-flex align-items-center" data-title="{{__('Edit ')}}">
