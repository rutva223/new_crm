...
@section('action-btn')
     ...
     data-title="{{__('Create New Branch')}}"> <span class="text-white">
...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0 ">{{__('Branch')}}
@endsection
@section('breadcrumb')
                                    ...
                                    <td class="Action text-right">
                                        <div class="action-btn bg-info ms-2">
                                            <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-ajax-popup="true"
                                                ...
                                                data-title="{{__('Edit Branch')}}"data-bs-toggle="tooltip" data-bs-original-title="{{ __('Edit') }}"> <span class="text-white"> <i
