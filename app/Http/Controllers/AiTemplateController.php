...
//     $templateName = Template::where('module',$moduleName)->pluck('template_name','id');
...
//    }
    ...
    { 
        ...
        return view('template_ai.generate_ai', compact('templateName'));
    }
   ...
   public function AiGenerate(Request $request) 
   {
       if ($request->ajax()) 
       {
            ...
            $modelName = Utility::settingsById(1);

                $complete = $open_ai->completion([
                    'model' => isset($modelName['chatgpt_model_name']) && !empty($modelName['chatgpt_model_name']) ? $modelName['chatgpt_model_name'] : '',
