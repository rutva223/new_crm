{{ Form::open(['route' => 'features_store', 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                {{ Form::textarea('other_featured_description', null, ['class' => 'summernote-simple form-control', 'placeholder' => __('Enter Description'), 'id' => 'mytextarea']) }}
            </div>
        </div>
